...
function scripts.mod_dps.update(this, store, script)
	...
	local function do_damage(target, value)
		...
		if m.source_id then
			...
			if source then
				if source.bullet then
					if source.bullet.damage_factor then
						d.value = value * source.bullet.damage_factor
					end
				elseif source.tower then
					if source.tower.damage_factor then
						d.value = value * source.tower.damage_factor
					end
				end
			end
			d.value = value
