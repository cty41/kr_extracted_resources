...
return {
			...
			shader_args = {
				{
					...
					p2 = p12,
					c1 = fc(0, 0, 0, 255),
					c2 = fc(201, 238, 147, 255),
					c3 = fc(84, 128, 18, 255)
				},
				{
					thickness = rs*2.5,
					outline_color = fc(20, 26, 13, 255)
				},
				{
					thickness = rs*1,
					glow_color = fc(20, 26, 13, 255)
				},
				{}
			}
		},
			...
			shader_args = {
				{
					...
					c1 = fc(0, 0, 0, 255),
					c2 = fc(255, 255, 255, 255),
					c3 = fc(17, 212, 246, 255)
				},
				{
					thickness = rs*2.5,
					outline_color = fc(6, 93, 111, 255)
				},
				{
					thickness = rs*1,
					glow_color = fc(6, 93, 111, 255)
				},
				{}
			}
		}
	...
	tower_data = {
		...
		{
			icon = 63,
			name = "tower_sunray_mini"
		},
		{
			section = "KRF Basic",
			icon = 79,
			name = "tower_archer_1_krf"
		},
		{
			icon = 80,
			name = "tower_barrack_1_krf"
		},
		{
			icon = 81,
			name = "tower_mage_1_krf"
		},
		{
			icon = 82,
			name = "tower_engineer_1_krf"
		},
		{
			icon = 83,
			name = "tower_archer_2_krf"
		},
		{
			icon = 84,
			name = "tower_barrack_2_krf"
		},
		{
			icon = 85,
			name = "tower_mage_2_krf"
		},
		{
			icon = 86,
			name = "tower_engineer_2_krf"
		},
		{
			icon = 87,
			name = "tower_archer_3_krf"
		},
		{
			icon = 88,
			name = "tower_barrack_3_krf"
		},
		{
			icon = 89,
			name = "tower_mage_3_krf"
		},
		{
			icon = 90,
			name = "tower_engineer_3_krf"
		},
		{
			section = "KRF Advanced",
			icon = 21,
			name = "tower_crossbow"
		},
		{
		...
		{
			icon = 69,
			name = "tower_barrack_amazonas_re"
		},
		{
			icon = 70,
		...
		},
		{
			section = "KRO Basic",
			icon = 48,
			name = "tower_tree_archer_1"
		},
		{
			icon = 49,
			name = "tower_elven_barrack_1"
		},
		{
			icon = 50,
			name = "tower_eldritch_mage_1"
		},
		{
			icon = 51,
		...
		{
			icon = 52,
			name = "tower_tree_archer_2"
		},
		{
			icon = 53,
			name = "tower_elven_barrack_2"
		},
		{
			icon = 54,
			name = "tower_eldritch_mage_2"
		},
		{
			icon = 55,
		...
		{
			icon = 56,
			name = "tower_tree_archer_3"
		},
		{
			icon = 57,
			name = "tower_elven_barrack_3"
		},
		{
			icon = 58,
			name = "tower_eldritch_mage_3"
		},
		{
			icon = 59,
		...
		{
			section = "KRV Advanced",
			icon = 37,
			name = "tower_shadow_archer"
		},
		{
			icon = 38,
			name = "tower_orc_warriors_den"
		},
		{
			icon = 39,
		...
		{
			icon = 40,
			name = "tower_rocket_riders"
		},
		{
			icon = 41,
			name = "tower_dark_knights"
		},
		{
			icon = 42,
			name = "tower_melting_furnace"
		},
		{
			icon = 43,
			name = "tower_spectres_mausoleum"
		},
		{
			icon = 44,
			name = "tower_goblirang"
		},
		{
			icon = 45,
		...
		{
			icon = 92,
			name = "tower_elite_harassers"
		},
		{
			icon = 93,
			name = "tower_orc_shaman"
		},
		{
			icon = 94,
			name = "tower_grim_cemetery"
		},
		{
			icon = 46,
			section = "KR Custom",
